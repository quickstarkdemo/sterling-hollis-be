...
The [examples page](https://developers.openai.com/apps-sdk/build/chatgpt-ui/examples#pizzaz-list-source) includes sample apps, such as the “Pizza list” app that lists pizza restaurants.
