...
class ImageGenerationJob(Base):
    ...
    api_trace_id: Mapped[str | None] = mapped_column(String(64), index=True)
    api_trace_span_id: Mapped[str | None] = mapped_column(String(64))
    api_trace_retry_of_job_id: Mapped[str | None] = mapped_column(String(64))
